...
/**
 * Class Model for sales details
 */
public class ModelTransactionPointOfSalesDetail implements Parcelable {
    ...
    // Constructor
    public ModelTransactionPointOfSalesDetail() {}
    ...
    protected ModelTransactionPointOfSalesDetail(Parcel in) {
        _id = in.readInt();
        date = in.readString();
    ...
    public static final Parcelable.Creator<ModelTransactionPointOfSalesDetail> CREATOR = new Parcelable.Creator<ModelTransactionPointOfSalesDetail>() {
        @Override
        public ModelTransactionPointOfSalesDetail createFromParcel(Parcel in) {
            return new ModelTransactionPointOfSalesDetail(in);
        }

        @Override
        public ModelTransactionPointOfSalesDetail[] newArray(int size) {
            return new ModelTransactionPointOfSalesDetail[size];
        }
    };
}
